...
export declare const defineTransaction: <TFormat extends Formatter<Partial<RpcTransaction>, Partial<Transaction> & {
    [key: string]: unknown;
}>, TExclude extends ("type" | "gas" | "value" | "gasPrice" | "maxFeePerGas" | "maxPriorityFeePerGas" | "blockHash" | "blockNumber" | "transactionIndex" | "hash" | "nonce" | "from" | "input" | "r" | "s" | "to" | "v" | "accessList" | "chainId")[] = []>({ exclude, format: formatOverride, }: {
